...
extension DatabaseManager {
    func ensureAppTableExists() throws {
        try dbPool.write { db in
            ...
            if !campaignTableExists {
                ...
                print("Campaign table created successfully") // Added print statement for consistency
            } else {
